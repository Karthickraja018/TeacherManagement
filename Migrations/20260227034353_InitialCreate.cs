    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                ...
                INSERT INTO [Addresses] ([AddressId], [Line1], [Line2], [City], [State], [Zip]) VALUES
                  (1, '123 Main St', '', 'Metropolis', 'State', '11111'),
                  (2, '456 Center Rd', '', 'Gotham', 'State', '22222'),
                  (3, '789 West Blvd', '', 'Star City', 'State', '33333'),
                  (4, '101 East Ave', '', 'Central City', 'State', '44444');
                ...
                INSERT INTO [Students] ([StudentId], [Name], [BranchId], [AddressId]) VALUES
                  (1, 'Alice', 1, 1),
                  (2, 'Bob', 2, 2),
                  (3, 'Charlie', 1, 3),
                  (4, 'Diana', 3, 4),
                ...
                INSERT INTO [Teachers] ([TeacherId], [TeacherName], [BranchId], [AddressId]) VALUES
                  (1, 'Dr. Smith', 1, 2),
                  (2, 'Ms. Johnson', 2, 1),
                  (3, 'Prof. Lee', 1, 3),
                  (4, 'Dr. Patel', 3, NULL);
